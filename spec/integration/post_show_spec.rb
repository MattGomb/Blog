...
RSpec.describe 'post show page', type: :system do
  before(:each) do
    @user = User.create(name: 'Jack Sparrow', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
                        bio: 'I\'m Captain Jack Sparrow!', posts_counter: 1)
    @user2 = User.create(name: 'Will Turner', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
                         bio: 'I\'m Will Turner!', posts_counter: 0)
    @post = Post.create(title: 'First Post', author: @user, text: 'I\'m the first post!',
                        likes_counter: 0, comments_counter: 6)
